        ...
        ProfileConfig {
            ...
            thresholds: Thresholds {
                ...
                expected_ranges: Some(ExpectedRanges {
                    survival: (0.9494, 0.9703),
                    host_fraction: (0.0001, 0.0007),
                    rrna_fraction: (0.0037, 0.0137),
                    adapter_rate: Some((0.0002, 0.0489)),
                    duplication_rate: Some((0.2702, 0.5128)),
        ...
        ProfileConfig {
            ...
            thresholds: Thresholds {
                ...
                expected_ranges: Some(ExpectedRanges {
                    ...
                    adapter_rate: Some((0.0001, 0.0759)),
                    duplication_rate: Some((0.4962, 0.6110)),
                    gc_content: Some((0.35, 0.55)),
                }),
            },
        }
        ...
        ProfileConfig {
            ...
            thresholds: Thresholds {
                ...
                expected_ranges: Some(ExpectedRanges {
                    ...
                    adapter_rate: Some((0.0002, 0.0166)),
                    duplication_rate: Some((0.2925, 0.5070)),
        ...
        ProfileConfig {
            ...
            thresholds: Thresholds {
                ...
                expected_ranges: Some(ExpectedRanges {
                    ...
                    adapter_rate: Some((0.0019, 0.0458)),
                    duplication_rate: Some((0.2949, 0.5737)),
                    gc_content: Some((0.35, 0.55)),
                }),
            },
        }
