...
fn build_html(passport_json: &str, passport: &Passport) -> String {
    ...
    let paired_html = if passport.pairs_passed > 0 {
        format!(
            r#"<div class="card"><div class="card-value">{}</div><div class="card-label">Pairs</div></div>
...
<div class="grid">
  <div class="card"><div class="card-value">{reads_input}</div><div class="card-label">Input</div></div>
  <div class="card"><div class="card-value">{reads_passed}</div><div class="card-label">Passed</div></div>
  <div class="card"><div class="card-value" style="color:var(--{tier_class})">{survival_pct:.1}%</div><div class="card-label">Survival</div></div>
  {dup_html}
  {paired_html}
</div>
...
<h2>Contaminants</h2>
<div class="grid">{contaminant_cards}</div>
...
<h2>Distributions</h2>
<div class="chart-row">
  <div class="chart-panel"><h3>Read Length</h3><canvas id="chart-length"></canvas></div>
...
<div class="chart-row">
  ...
  <div class="chart-panel"><h3>Bases Trimmed</h3><canvas id="chart-trimmed"></canvas></div>
</div>
